...
export async function GET(req: NextRequest) {
  try {
    ...
    const title = searchParams.get('title') || 'Atelier Logos Blog';
    const subtitle = searchParams.get('subtitle') || 'Insights on spec-driven development and LLM-assisted programming';

    // Fetch logo
    const logoUrl = new URL('/logo.png', req.url.replace('/api/og/blog', '')).toString();
    ...
    console.error('Blog OG Image Error:', e);
